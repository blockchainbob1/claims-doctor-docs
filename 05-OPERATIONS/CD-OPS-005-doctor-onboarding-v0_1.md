---
doc_id: CD-OPS-005
title: "Doctor Onboarding & Credentialing SOP"
version: 0.1
status: DRAFT
visibility: INTERNAL
...
# Doctor Onboarding & Credentialing SOP
...
_Describe what this document exists to achieve. One to two sentences._

---

## 02 Scope

_Who does this apply to? What does it cover? What does it explicitly not cover?_
...
_Main body of the document goes here. Use numbered sections (04, 05, 06...) for additional major sections as needed._
...
|--------|-------|-------------|
| CD-GOV-002 | — | Depends on |
| CD-OPS-001 | — | Depends on |
...
_Document ID: CD-OPS-005 · Version 0.1 · Status: DRAFT · Visibility: INTERNAL_
